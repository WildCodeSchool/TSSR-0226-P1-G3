...
![](Activation-de-l-option-Partager-ce-dossier-et-validation.png)
...
![](Acces-aux-Parametres-de-Windows11-Systeme-Bureau-a-distance.png)

2. Bascule du commutateur sur **Activé**.
3. Validation de l'avertissement de sécurité Windows.
   
![](Bascule-du-commutateur-sur-Active-et-validation.png)
...
![](Verification-local-des-ports-ouverts-win11.png)
