...
* **Procédure de mise en place :**
  1. Ouverture de l'Explorateur de fichiers sur le lecteur `C:`.![[Ouverture de l'Explorateur de fichiers sur le lecteur C.png]]
  2. Création d'un dossier nommé `Partage_Projet`.![[Création d'un dossier nommé Partage_Projet.png]]
...
* **Procédure de mise en place :**
  ...
  2. 3Bascule du commutateur sur **Activé**.
